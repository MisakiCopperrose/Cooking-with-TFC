...
public class BlockPlanks extends BlockTerra
{
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer entityplayer, int side, float par7, float par8, float par9) 
	{
		...
		if(entityplayer.ridingEntity != null && entityplayer instanceof EntityPlayerMP && entityplayer.getDistanceSq(x, y, z) < 12 &&
		world.getBlock(x, y+1, z).isAir(world, x, y+1, z)&& world.getBlock(x, y+2, z).isAir(world, x, y+2, z))
		{
			entityplayer.mountEntity(null);
			//player.ridingEntity = null;
			((EntityPlayerMP)entityplayer).playerNetServerHandler.setPlayerLocation(x	, y+1, z, entityplayer.rotationYaw, entityplayer.rotationPitch);
