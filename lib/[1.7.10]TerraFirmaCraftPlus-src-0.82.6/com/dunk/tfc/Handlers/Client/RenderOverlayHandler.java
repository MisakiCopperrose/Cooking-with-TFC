...
public class RenderOverlayHandler
{
	...
	public void render(RenderGameOverlayEvent.Pre event)
	{
		...
		boolean canAttack = playerInfo !=null?playerInfo.canAttack():true;
		...
		if(!canAttack && sr != null)
		{
			fontrenderer.drawString("+", sr.getScaledWidth()/2 - 2, sr.getScaledHeight()/2 - 3, Color.RED.getRGB());
	...
	public void renderText(RenderGameOverlayEvent.Text event)
	{
		...
		if (mc.gameSettings.showDebugInfo || TFCOptions.enableDebugMode)
		{
			...
			if (TFCOptions.enableDebugMode)
			{
				...
				event.left.add("Max Temp: "
						+ TFC_Climate.getMaxTemperature(mc.theWorld, 0, yCoord, zCoord));
			}
		}
