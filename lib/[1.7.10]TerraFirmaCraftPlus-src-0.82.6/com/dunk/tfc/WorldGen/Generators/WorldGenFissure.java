...
public class WorldGenFissure implements IWorldGenerator
{
	...
	public void generate(World world, Random rand, int x, int y, int z)
	{
		...
		if(checkStability && stability == 0)
			return;
		if(stability == 1 && fillBlock != null && fillBlock.getMaterial() == Material.water && (biome==TFCBiome.MOUNTAINS || biome==TFCBiome.MOUNTAINS_EDGE || biome == TFCBiome.MOUNTAIN_RANGE || biome == TFCBiome.MOUNTAIN_RANGE_EDGE))
