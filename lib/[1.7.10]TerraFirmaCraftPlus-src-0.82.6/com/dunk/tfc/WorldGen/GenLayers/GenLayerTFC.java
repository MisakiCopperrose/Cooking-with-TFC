...
import com.dunk.tfc.WorldGen.GenLayers.Mountains.GenLayerMountainRangeMixTFC;
import com.dunk.tfc.WorldGen.GenLayers.Mountains.GenLayerMountainRangeTFC;
import com.dunk.tfc.WorldGen.GenLayers.Mountains.GenLayerMountainsInitTFC;
...
public abstract class GenLayerTFC extends GenLayer
{
	...
	public static GenLayerTFC[] initialize(long par0, TFCWorldType par2)
	{
		...
		GenLayerRiverMixTFC riverMix = new GenLayerRiverMixTFC(100L, TFCBiome.RIVER.biomeID, smoothContinent, riverCont);
		...
		GenLayerTFC mountainCont = GenLayerZoomTFC.magnify(1000L, var18, 2);
		drawImage(512, mountainCont, "1 ContinentsZoom Mountains");
		mountainCont = new GenLayerMountainsInitTFC(100L, mountainCont);
		drawImage(512, mountainCont, "2 MountainInit");
	/*	mountainCont = GenLayerZoomTFC.magnify(1000L, mountainCont, 6);
		drawImage(512, mountainCont, "3 MountainInitZoom");*/
		mountainCont = new GenLayerMountainRangeTFC(1L, mountainCont);
		drawImage(512, mountainCont, "4 Mountains");
		mountainCont = new GenLayerSmoothTFC(1000L, mountainCont);
		drawImage(512, mountainCont, "5 Mountain");		
		
		
		
		//GenLayerSmoothBiomeTFC smoothContinent2 = new GenLayerSmoothBiomeTFC(1000L, finalCont);
		//drawImage(512, smoothContinent2, "Biome 19");
		GenLayerMountainRangeMixTFC mountainMix = new GenLayerMountainRangeMixTFC(100L, riverMix, mountainCont);
		drawImage(512, mountainMix, "Biome 20 Mountains");
	...
	/*	GenLayerSmoothBiomeTFC smoothContinent2 = new GenLayerSmoothBiomeTFC(1000L, finalCont);
		drawImage(512, smoothContinent2, "Biome 19");
		GenLayerRiverMixTFC mountainMix = new GenLayerRiverMixTFC(100L, TFCBiome.MOUNTAINS.biomeID, smoothContinent2, mountainCont);
		drawImage(512, mountainMix, "Biome 20");
		GenLayerTFC finalCont2 = GenLayerZoomTFC.magnify(1000L, mountainMix, 2);
		drawImage(512, finalCont2, "Biome 20-zoom");
		finalCont2 = new GenLayerSmoothBiomeTFC(1001L, finalCont2);
		drawImage(512, finalCont2, "Biome 21");*/
		
		riverMix.initWorldGenSeed(par0);
		mountainMix.initWorldGenSeed(par0);
		finalCont.initWorldGenSeed(par0);
		drawImage(1024, mountainMix, "Real Seed " + (par0));
		shouldDraw = false;
		//mountainCont.initWorldGenSeed(par0);
		return new GenLayerTFC[]{/*riverMix*/mountainMix, finalCont};
	}
