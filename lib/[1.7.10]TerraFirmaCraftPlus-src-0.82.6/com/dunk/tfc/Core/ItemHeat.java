...
public class ItemHeat
{
	...
	public static void setupItemHeat()
	{
		...
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Native Copper")), copperRaw, new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Native Gold")), goldRaw,new ItemStack(TFCItems.goldUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Native Platinum")), platinumRaw,new ItemStack(TFCItems.platinumUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Hematite")), ironRaw,new ItemStack(TFCItems.pigIronUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Native Silver")), silverRaw,new ItemStack(TFCItems.silverUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Cassiterite")), tinRaw,new ItemStack(TFCItems.tinUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Galena")), leadRaw,new ItemStack(TFCItems.leadUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Bismuthinite")), bismuthRaw,new ItemStack(TFCItems.bismuthUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Garnierite")), nickelRaw,new ItemStack(TFCItems.nickelUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Malachite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Magnetite")), ironRaw,new ItemStack(TFCItems.pigIronUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Limonite")), ironRaw,new ItemStack(TFCItems.pigIronUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Sphalerite")), zincRaw,new ItemStack(TFCItems.zincUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Tetrahedrite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Chalcocite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,ores.indexOf("Chalcopyrite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset + ores.indexOf("Native Copper")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset + ores.indexOf("Native Gold")), goldRaw,new ItemStack(TFCItems.goldUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset + ores.indexOf("Native Platinum")), platinumRaw,new ItemStack(TFCItems.platinumUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset + ores.indexOf("Hematite")), ironRaw,new ItemStack(TFCItems.pigIronUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset + ores.indexOf("Native Silver")), silverRaw,new ItemStack(TFCItems.silverUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset + ores.indexOf("Cassiterite")), tinRaw,new ItemStack(TFCItems.tinUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset + ores.indexOf("Galena")), leadRaw,new ItemStack(TFCItems.leadUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset + ores.indexOf("Bismuthinite")), bismuthRaw,new ItemStack(TFCItems.bismuthUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset + ores.indexOf("Garnierite")), nickelRaw,new ItemStack(TFCItems.nickelUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset + ores.indexOf("Malachite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset + ores.indexOf("Magnetite")), ironRaw,new ItemStack(TFCItems.pigIronUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset + ores.indexOf("Limonite")), ironRaw,new ItemStack(TFCItems.pigIronUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset + ores.indexOf("Sphalerite")), zincRaw,new ItemStack(TFCItems.zincUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset + ores.indexOf("Tetrahedrite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset +ores.indexOf("Chalcocite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade1Offset +ores.indexOf("Chalcopyrite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset + ores.indexOf("Native Copper")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset + ores.indexOf("Native Gold")), goldRaw,new ItemStack(TFCItems.goldUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset + ores.indexOf("Native Platinum")), platinumRaw,new ItemStack(TFCItems.platinumUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset + ores.indexOf("Hematite")), ironRaw,new ItemStack(TFCItems.pigIronUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset + ores.indexOf("Native Silver")), silverRaw,new ItemStack(TFCItems.silverUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset + ores.indexOf("Cassiterite")), tinRaw,new ItemStack(TFCItems.tinUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset + ores.indexOf("Galena")), leadRaw,new ItemStack(TFCItems.leadUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset + ores.indexOf("Bismuthinite")), bismuthRaw,new ItemStack(TFCItems.bismuthUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset + ores.indexOf("Garnierite")), nickelRaw,new ItemStack(TFCItems.nickelUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset + ores.indexOf("Malachite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset + ores.indexOf("Magnetite")), ironRaw,new ItemStack(TFCItems.pigIronUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset + ores.indexOf("Limonite")), ironRaw,new ItemStack(TFCItems.pigIronUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset + ores.indexOf("Sphalerite")), zincRaw,new ItemStack(TFCItems.zincUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset + ores.indexOf("Tetrahedrite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset +ores.indexOf("Chalcocite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.oreChunk,1,Global.oreGrade2Offset +ores.indexOf("Chalcopyrite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		...
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Native Copper")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Native Gold")), goldRaw,new ItemStack(TFCItems.goldUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Native Platinum")), platinumRaw,new ItemStack(TFCItems.platinumUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Hematite")), ironRaw,new ItemStack(TFCItems.pigIronUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Native Silver")), silverRaw,new ItemStack(TFCItems.silverUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Cassiterite")), tinRaw,new ItemStack(TFCItems.tinUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Galena")), leadRaw,new ItemStack(TFCItems.leadUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Bismuthinite")), bismuthRaw,new ItemStack(TFCItems.bismuthUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Garnierite")), nickelRaw,new ItemStack(TFCItems.nickelUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Malachite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Magnetite")), ironRaw,new ItemStack(TFCItems.pigIronUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Limonite")), ironRaw,new ItemStack(TFCItems.pigIronUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Sphalerite")), zincRaw,new ItemStack(TFCItems.zincUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Tetrahedrite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Chalcocite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.smallOreChunk,1,ores.indexOf("Chalcopyrite")), copperRaw,new ItemStack(TFCItems.copperUnshaped,1)));
		// Invallid
		...
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.wheatGerm, 1), 1, 1200, null));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.barleyGerm, 1), 1, 1200, null));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.ryeGerm, 1), 1, 1200, null));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.riceGerm, 1), 1, 1200, null));
		manager.addIndex(new HeatIndex(new ItemStack(TFCItems.cornGerm, 1), 1, 1200, null));
