...
public class TFC_Sounds
{
	...
	public static final String BEES = LOCATION + "mob.bees";
	public static final String CICADAS = LOCATION + "mob.cicadas";
	public static final String JUNGLE = LOCATION + "mob.jungle";
	public static final String JUNGLECHIRPS = LOCATION + "mob.jungleChirps";
	public static final String RIVER = LOCATION + "ambient.river";
