...
public class TFC_ConfigFiles
{
	...
	public static void reloadOres()
	{
		...
		oreList.put("Chalcocite", getOreData("Chalcocite", "veins", "large", MOD_ID + ":Ore1b", 0, 120, new String[]{"sedimentary"}, 5, 128, 80, 60));
		oreList.put("Chalcopyrite", getOreData("Chalcopyrite", "veins", "large", MOD_ID + ":Ore1b", 1, 120, new String[]{"igneous intrusive"}, 5, 128, 80, 60));
		...
		oreList.put("Chalcocite Surface", getOreData("Chalcocite Surface", "veins", "small", MOD_ID + ":Ore1b", 0, 35, new String[]{"sedimentary"}, 128, 240, 40, 40));
		oreList.put("Chalcopyrite Surface", getOreData("Chalcopyrite Surface", "veins", "small", MOD_ID + ":Ore1b", 1, 35, new String[]{"igneous intrusive"}, 128, 240, 40, 40));
