...
public class TFC_OreDictionary
{
	public static void registerOreDict()
	{
		...
		//Ores
		OreDictionary.registerOre("oreNormalCopper", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Native Copper"))); //Native Copper
		OreDictionary.registerOre("oreNormalCopper", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Malachite"))); //Malachite
		OreDictionary.registerOre("oreNormalCopper", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Tetrahedrite"))); //Tetrahedrite		
		OreDictionary.registerOre("oreNormalCopper", new ItemStack(TFCItems.oreChunk, 1,  ores.indexOf("Chalcocite"))); //Chalcocite
		OreDictionary.registerOre("oreNormalCopper", new ItemStack(TFCItems.oreChunk, 1,  ores.indexOf("Chalcopyrite"))); //Chalcopyrite
		OreDictionary.registerOre("oreSmallCopper", new ItemStack(TFCItems.smallOreChunk, 1, ores.indexOf("Native Copper"))); //Native Copper
		OreDictionary.registerOre("oreSmallCopper", new ItemStack(TFCItems.smallOreChunk, 1, ores.indexOf("Malachite"))); //Malachite
		OreDictionary.registerOre("oreSmallCopper", new ItemStack(TFCItems.smallOreChunk, 1, ores.indexOf("Tetrahedrite"))); //Tetrahedrite		
		OreDictionary.registerOre("oreSmallCopper", new ItemStack(TFCItems.oreChunk, 1,  ores.indexOf("Chalcocite"))); //Chalcocite
		OreDictionary.registerOre("oreSmallCopper", new ItemStack(TFCItems.oreChunk, 1,  ores.indexOf("Chalcopyrite"))); //Chalcopyrite
		OreDictionary.registerOre("oreRichCopper", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade1Offset + ores.indexOf("Native Copper"))); //Native Copper
		OreDictionary.registerOre("oreRichCopper", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade1Offset + ores.indexOf("Malachite"))); //Malachite
		OreDictionary.registerOre("oreRichCopper", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade1Offset + ores.indexOf("Tetrahedrite"))); //Tetrahedrite		
		OreDictionary.registerOre("oreRichCopper", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade1Offset + ores.indexOf("Chalcocite"))); //Chalcocite
		OreDictionary.registerOre("oreRichCopper", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade1Offset + ores.indexOf("Chalcopyrite"))); //Chalcopyrite
		OreDictionary.registerOre("orePoorCopper", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset + ores.indexOf("Native Copper"))); //Native Copper
		OreDictionary.registerOre("orePoorCopper", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset + ores.indexOf("Malachite"))); //Malachite
		OreDictionary.registerOre("orePoorCopper", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset + ores.indexOf("Tetrahedrite"))); //Tetrahedrite
		OreDictionary.registerOre("orePoorCopper", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset + ores.indexOf("Chalcocite"))); //Chalcocite
		OreDictionary.registerOre("orePoorCopper", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset + ores.indexOf("Chalcopyrite"))); //Chalcopyrite

		OreDictionary.registerOre("oreNormalGold", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Native Gold"))); //Native Gold
		OreDictionary.registerOre("oreSmallGold", new ItemStack(TFCItems.smallOreChunk, 1, ores.indexOf("Native Gold"))); //Native Gold
		OreDictionary.registerOre("oreRichGold", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade1Offset + ores.indexOf("Native Gold"))); //Native Gold
		OreDictionary.registerOre("orePoorGold", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset + ores.indexOf("Native Gold"))); //Native Gold

		OreDictionary.registerOre("oreNormalPlatinum", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Native Platinum"))); //Native Platinum
		OreDictionary.registerOre("oreSmallPlatinum", new ItemStack(TFCItems.smallOreChunk, 1, ores.indexOf("Native Platinum"))); //Native Platinum
		OreDictionary.registerOre("oreRichPlatinum", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade1Offset + ores.indexOf("Native Platinum"))); //Native Platinum
		OreDictionary.registerOre("orePoorPlatinum", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset + ores.indexOf("Native Platinum"))); //Native Platinum

		OreDictionary.registerOre("oreNormalIron", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Hematite"))); //Hematite
		OreDictionary.registerOre("oreNormalIron", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Magnetite"))); //Magnetite
		OreDictionary.registerOre("oreNormalIron", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Limonite"))); //Limonite
		OreDictionary.registerOre("oreSmallIron", new ItemStack(TFCItems.smallOreChunk, 1, ores.indexOf("Hematite"))); //Hematite
		OreDictionary.registerOre("oreSmallIron", new ItemStack(TFCItems.smallOreChunk, 1, ores.indexOf("Magnetite"))); //Magnetite
		OreDictionary.registerOre("oreSmallIron", new ItemStack(TFCItems.smallOreChunk, 1, ores.indexOf("Limonite"))); //Limonite		
		OreDictionary.registerOre("oreRichIron", new ItemStack(TFCItems.oreChunk, 1,Global.oreGrade1Offset + ores.indexOf("Hematite"))); //Hematite
		OreDictionary.registerOre("oreRichIron", new ItemStack(TFCItems.oreChunk, 1,Global.oreGrade1Offset + ores.indexOf("Magnetite"))); //Magnetite
		OreDictionary.registerOre("oreRichIron", new ItemStack(TFCItems.oreChunk, 1,Global.oreGrade1Offset + ores.indexOf("Limonite"))); //Limonite		
		OreDictionary.registerOre("orePoorIron", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset + ores.indexOf("Hematite"))); //Hematite
		OreDictionary.registerOre("orePoorIron", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset + ores.indexOf("Magnetite"))); //Magnetite
		OreDictionary.registerOre("orePoorIron", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset + ores.indexOf("Limonite"))); //Limonite

		OreDictionary.registerOre("oreNormalSilver", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Native Silver"))); //Native Silver
		OreDictionary.registerOre("oreSmallSilver", new ItemStack(TFCItems.smallOreChunk, 1, ores.indexOf("Native Silver"))); //Native Silver
		OreDictionary.registerOre("oreRichSilver", new ItemStack(TFCItems.oreChunk, 1,Global.oreGrade1Offset + ores.indexOf("Native Silver"))); //Native Silver
		OreDictionary.registerOre("orePoorSilver", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset + ores.indexOf("Native Silver"))); //Native Silver

		OreDictionary.registerOre("oreNormalTin", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Cassiterite"))); //Cassiterite
		OreDictionary.registerOre("oreSmallTin", new ItemStack(TFCItems.smallOreChunk, 1, ores.indexOf("Cassiterite"))); //Cassiterite
		OreDictionary.registerOre("oreRichTin", new ItemStack(TFCItems.oreChunk, 1,Global.oreGrade1Offset + ores.indexOf("Cassiterite"))); //Cassiterite
		OreDictionary.registerOre("orePoorTin", new ItemStack(TFCItems.oreChunk, 1,  Global.oreGrade2Offset + ores.indexOf("Cassiterite"))); //Cassiterite

		OreDictionary.registerOre("oreNormalLead", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Galena"))); //Galena
		OreDictionary.registerOre("oreSmallLead", new ItemStack(TFCItems.smallOreChunk, 1, ores.indexOf("Galena"))); //Galena
		OreDictionary.registerOre("oreRichLead", new ItemStack(TFCItems.oreChunk, 1,Global.oreGrade1Offset + ores.indexOf("Galena"))); //Galena
		OreDictionary.registerOre("orePoorLead", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset + ores.indexOf("Galena"))); //Galena

		OreDictionary.registerOre("oreNormalBismuth", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Bismuthinite"))); //Bismuthinite
		OreDictionary.registerOre("oreSmallBismuth", new ItemStack(TFCItems.smallOreChunk, 1, ores.indexOf("Bismuthinite"))); //Bismuthinite
		OreDictionary.registerOre("oreRichBismuth", new ItemStack(TFCItems.oreChunk, 1,Global.oreGrade1Offset + ores.indexOf("Bismuthinite"))); //Bismuthinite
		OreDictionary.registerOre("orePoorBismuth", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset +ores.indexOf("Bismuthinite"))); //Bismuthinite

		OreDictionary.registerOre("oreNormalNickel", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Garnierite"))); //Garnierite
		OreDictionary.registerOre("oreSmallNickel", new ItemStack(TFCItems.smallOreChunk, 1, ores.indexOf("Garnierite"))); //Garnierite
		OreDictionary.registerOre("oreRichNickel", new ItemStack(TFCItems.oreChunk, 1,Global.oreGrade1Offset + ores.indexOf("Garnierite"))); //Garnierite
		OreDictionary.registerOre("orePoorNickel", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset + ores.indexOf("Garnierite"))); //Garnierite

		OreDictionary.registerOre("oreNormalZinc", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Sphalerite"))); //Sphalerite
		OreDictionary.registerOre("oreSmallZinc", new ItemStack(TFCItems.smallOreChunk, 1, ores.indexOf("Sphalerite"))); //Sphalerite
		OreDictionary.registerOre("oreRichZinc", new ItemStack(TFCItems.oreChunk, 1,Global.oreGrade1Offset + ores.indexOf("Sphalerite"))); //Sphalerite
		OreDictionary.registerOre("orePoorZinc", new ItemStack(TFCItems.oreChunk, 1, Global.oreGrade2Offset + ores.indexOf("Sphalerite"))); //Sphalerite

		OreDictionary.registerOre("oreCoal", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Bituminous Coal"))); //Bituminous Coal
		OreDictionary.registerOre("oreCoal", new ItemStack(TFCItems.oreChunk, 1, ores.indexOf("Lignite"))); //Lignite

		OreDictionary.registerOre("oreKaolinite", new ItemStack(TFCItems.oreChunk, 1, Global.oreSize + minerals.indexOf("Kaolinite")));
		OreDictionary.registerOre("oreGypsum", new ItemStack(TFCItems.oreChunk, 1, Global.oreSize +minerals.indexOf("Gypsum")));
		OreDictionary.registerOre("oreSatinspar", new ItemStack(TFCItems.oreChunk, 1, Global.oreSize +minerals.indexOf("Satinspar")));
		OreDictionary.registerOre("oreSelenite", new ItemStack(TFCItems.oreChunk, 1, Global.oreSize +minerals.indexOf("Selenite")));
		OreDictionary.registerOre("oreGraphite", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Graphite")));
		OreDictionary.registerOre("oreDiamond", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Kimberlite"))); //Kimberlite
		OreDictionary.registerOre("orePetrifiedWood", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Petrified Wood")));
		OreDictionary.registerOre("oreSulfur", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Sulfur")));
		OreDictionary.registerOre("oreJet", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Jet")));
		OreDictionary.registerOre("oreMicrocline", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Microline")));
		OreDictionary.registerOre("oreUranium", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Pitchblende"))); //Pitchblende

		OreDictionary.registerOre("oreRedstone", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Cinnabar"))); //Cinnabar
		OreDictionary.registerOre("oreRedstone", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Cryolite"))); //Cryolite

		OreDictionary.registerOre("oreSaltpeter", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Saltpeter")));
		OreDictionary.registerOre("oreSerpentine", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Serpentine")));
		OreDictionary.registerOre("oreSylvite", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Sylvite")));
		OreDictionary.registerOre("oreBorax", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Borax")));
		OreDictionary.registerOre("oreOlivine", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Olivine")));
		OreDictionary.registerOre("oreLapis", new ItemStack(TFCItems.oreChunk, 1,Global.oreSize + minerals.indexOf("Lapis Lazuli")));
		...
		OreDictionary.registerOre("stoneBricks", new ItemStack(TFCBlocks.stoneIgExLargeBrick, 1, WILD));
		OreDictionary.registerOre("stoneBricks", new ItemStack(TFCBlocks.stoneIgInLargeBrick, 1, WILD));
		OreDictionary.registerOre("stoneBricks", new ItemStack(TFCBlocks.stoneMMLargeBrick, 1, WILD));
		OreDictionary.registerOre("stoneBricks", new ItemStack(TFCBlocks.stoneSedLargeBrick, 1, WILD));
		...
		OreDictionary.registerOre("materialString", new ItemStack(TFCItems.cottonYarn));
		...
		OreDictionary.registerOre("materialCloth", new ItemStack(TFCItems.cottonCloth));
