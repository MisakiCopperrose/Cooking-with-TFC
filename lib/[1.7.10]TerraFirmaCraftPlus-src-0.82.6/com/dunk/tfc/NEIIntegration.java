...
public class NEIIntegration
{
	public static void hideNEIItems()
	{
		...
		if (TFCOptions.enableNEIHiding)
		{
			...
			API.hideItem(new ItemStack(TFCBlocks.ore1b));
			...
			API.hideItem(new ItemStack(TFCBlocks.stackedWoodHoriz, 1, OreDictionary.WILDCARD_VALUE));
			API.hideItem(new ItemStack(TFCBlocks.stackedWoodHoriz2, 1, OreDictionary.WILDCARD_VALUE));
			API.hideItem(new ItemStack(TFCBlocks.stackedWoodHoriz3, 1, OreDictionary.WILDCARD_VALUE));
			API.hideItem(new ItemStack(TFCBlocks.stackedWoodHoriz4, 1, OreDictionary.WILDCARD_VALUE));
