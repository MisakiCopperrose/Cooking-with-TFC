...
public class TELoom extends NetworkTileEntity implements IInventory
{
	...
	public void setModel(ModelLoom loomModel){
		if(worldObj.isRemote){
			...
			if(!this.primitive)
			{
				//This may make it work twice as fast?
				model.mod = 20;
			}
	...
	public ResourceLocation getWoodResource(){
		if(primitive)
		{
			return new ResourceLocation(Reference.MOD_ID, "textures/blocks/wood/WoodSheet/"+Global.WOOD_ALL[5]+".png");
		}
	...
	public void readFromNBT(NBTTagCompound nbt)
	{
		...
		primitive = nbt.getBoolean("primitive");
	...
	public static void registerRecipes()
	{
		...
		LoomManager.getInstance().addRecipe(new LoomRecipe(new ItemStack(TFCItems.cottonYarn,20), new ItemStack(TFCItems.cottonCloth,1)),new ResourceLocation(Reference.MOD_ID, "textures/blocks/cottonCloth.png"));
		...
		LoomManager.getInstance().addRecipe(new LoomRecipe(new ItemStack(TFCItems.sisalFiber,12), new ItemStack(TFCItems.burlapCloth,1)),new ResourceLocation(Reference.MOD_ID, "textures/blocks/Rope.png"));
	}
}
