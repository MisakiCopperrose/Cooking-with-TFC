...
public class TEFirepit extends TEFireEntity implements IInventory
{
	...
	public void cookItem()
	{
		...
		if (fireItemStacks[1] != null)
		{
			...
			else if (fireItemStacks[1] != null && fireItemStacks[1].getItem() instanceof ItemClothing && this.fireTemp > 100)
			{
		...
		if (!worldObj.isRemote)
		{
																				...
																				// fit.
			{
				...
				for (Iterator iterator = list.iterator(); iterator.hasNext();)
				{
					...
					if (item == TFCItems.logs || item == Item.getItemFromBlock(TFCBlocks.peat)|| item == TFCItems.stick)
					{
