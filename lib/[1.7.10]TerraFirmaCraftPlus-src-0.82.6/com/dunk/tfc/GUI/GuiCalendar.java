...
public class GuiCalendar extends GuiScreen
{
	...
	public void initGui()
	{
		...
		{
			buttonList.add(new GuiButton(0, guiLeft+20 + 27, guiTop + 118, 66, 20, TFC_Core.translate("gui.Calendar.1Hour")));
			buttonList.add(new GuiButton(1, guiLeft+20+ 27, guiTop + 137, 66, 20, TFC_Core.translate("gui.Calendar.1Day")));
			buttonList.add(new GuiButton(2, guiLeft + 85+ 27, guiTop + 118, 66, 20, TFC_Core.translate("gui.Calendar.1Month")));
			buttonList.add(new GuiButton(3, guiLeft + 85+ 27, guiTop + 137, 66, 20, TFC_Core.translate("gui.Calendar.1Year")));
		}

		buttonList.add(new GuiInventoryButton(4, guiLeft + xSize, guiTop + 9, 25, 20, 
				0, 86, 25, 20, TFC_Core.translate("gui.Inventory.Inventory"), TFC_Textures.guiInventory));
		buttonList.add(new GuiInventoryButton(5, guiLeft + xSize, guiTop + 28, 25, 20, 
				0, 86, 25, 20, TFC_Core.translate("gui.Inventory.Skills"), TFC_Textures.guiSkills));
		buttonList.add(new GuiInventoryButton(6, guiLeft + xSize, guiTop + 47, 25, 20, 
				0, 86, 25, 20, TFC_Core.translate("gui.Calendar.Calendar"), TFC_Textures.guiCalendar));
		buttonList.add(new GuiInventoryButton(7, guiLeft + xSize, guiTop + 66, 25, 20, 
	...
	public void drawScreen(int par1, int par2, float par3)
	{
		...
		drawCenteredString(fontRendererObj,TFC_Core.translate("gui.Calendar.Calendar"), /*l+87*/ width/2, i1+16, 0xFFFFFF);
		drawCenteredString(fontRendererObj,TFC_Core.translate("gui.Calendar.Season") + " : " + TFC_Time.SEASONS[TFC_Time.getSeasonAdjustedMonth((int)(player.posZ))], /*l + 87*/width/2, i1+26, 0x000000);
		...
		drawCenteredString(fontRendererObj, TFC_Core.translate("gui.Calendar.Day") + " : " + day, /*l + 87*/width/2, i1 + 36, 0x000000);
        ...
        drawCenteredString(fontRendererObj, TFC_Core.translate("gui.Calendar.Date") + " : " + dom + " " + TFC_Time.MONTHS[month] + ", " + year,/*l + 87*/width/2, i1 + 46, 0x000000);
		...
		if(h == 0)
			...
			hour+=h;
		drawCenteredString(fontRendererObj,TFC_Core.translate("gui.Calendar.Hour") + " : " + hour,/*l + 87*/width/2, i1+56, 0x000000);
