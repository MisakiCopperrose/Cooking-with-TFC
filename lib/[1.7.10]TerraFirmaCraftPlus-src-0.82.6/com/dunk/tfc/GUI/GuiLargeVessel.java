...
public class GuiLargeVessel extends GuiContainerTFC
{
	...
	protected void drawGuiContainerBackgroundLayer(float f, int mouseX, int mouseY)
	{
		...
		if (guiTab == 0)
		{
			...
			vesselTE.recipe =  BarrelManager.getInstance().findMatchingRecipe(vesselTE.getInputStack(), vesselTE.getFluidStack(), vesselTE.getSealed(),
			vesselTE.getTechLevel(), vesselTE.isHeated(),vesselTE);
			// Draw Output
