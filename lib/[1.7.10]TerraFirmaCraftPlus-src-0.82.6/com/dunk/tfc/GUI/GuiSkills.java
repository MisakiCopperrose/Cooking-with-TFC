...
public class GuiSkills extends GuiContainerTFC
{
	...
	protected int skillWidth = 230 - 8;


	public GuiSkills(EntityPlayer player)
	{
		super(new ContainerSkills(player), 230, 166);
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2)
	{
		...
		for (Skill o : SkillsManager.instance.getSkillsArray())
		{
			...
			{
				bindTexture(texture);
				drawTexturedModalRect(4, y, 4, 208, /*168*/ skillWidth, 16);
				y += 12;
				float perc = ss.getPercToNextRank(o.skillName);
				drawTexturedModalRect(4, y, 4, 168, /*168*/ skillWidth, 4);
				drawTexturedModalRect(4, y, 4, 172, (int) Math.floor(/*168*/ skillWidth * perc), 4);
	...
	public void createButtons()
	{
		...
		buttonList.clear();
		buttonList.add(new GuiInventoryButton(0, guiLeft + xSize, guiTop, 25, 20, 0, 86, 25, 20, TFC_Core.translate("gui.Inventory.Inventory"), TFC_Textures.guiInventory));
		buttonList.add(new GuiInventoryButton(1, guiLeft + xSize, guiTop + 19, 25, 20, 0, 86, 25, 20, TFC_Core.translate("gui.Inventory.Skills"), TFC_Textures.guiSkills));
		buttonList.add(new GuiInventoryButton(2, guiLeft + xSize, guiTop + 38, 25, 20, 0, 86, 25, 20, TFC_Core.translate("gui.Calendar.Calendar"), TFC_Textures.guiCalendar));
		buttonList.add(new GuiInventoryButton(3, guiLeft + xSize, guiTop + 57, 25, 20, 0, 86, 25, 20, TFC_Core.translate("gui.Inventory.Health"), TFC_Textures.guiHealth));
