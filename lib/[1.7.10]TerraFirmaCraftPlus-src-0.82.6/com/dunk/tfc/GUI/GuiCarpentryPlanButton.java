...
public class GuiCarpentryPlanButton extends GuiButton
{
	private GuiCarpentry screen;
	protected static final RenderItem ITEM_RENDERER = new RenderItem();

	public GuiCarpentryPlanButton(int index, int xPos, int yPos, int width, int height, GuiCarpentry gui, String s)
	{
