...
public class GetTreesCommand extends CommandBase{
	...
	public void processCommand(ICommandSender sender, String[] params) 
	{
		...
		float f= TFC_Core.calculateLocalCelestialAngle(sender.getEntityWorld(), cc.posX, cc.posY, cc.posZ, TFC_Time.getTotalTicks(), 0);
		float light = TFC_Core.getCelestialDaylight(sender.getEntityWorld(), cc.posX, cc.posY, cc.posZ, TFC_Time.getTotalTicks(), 0);
		throw new PlayerNotFoundException("Celestial Angle: " + f + " Celestial Light: " + light + " time: " + TFC_Time.getHour());
	}
