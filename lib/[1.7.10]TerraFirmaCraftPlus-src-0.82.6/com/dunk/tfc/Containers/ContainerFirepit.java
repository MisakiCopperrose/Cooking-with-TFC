	...
	public ItemStack transferStackInSlotTFC(EntityPlayer player, int slotNum)
	{
		...
		if(slot != null && slot.getHasStack())
		{
			...
			else
			{
				...
				if (!(slotStack.getItem() instanceof ItemOre) && manager.findMatchingIndex(slotStack) != null && !slotinput.getHasStack())
				{
				...
				else if (slotStack.getItem() == TFCItems.logs || slotStack.getItem() == TFCItems.stick ||  slotStack.getItem() == Item.getItemFromBlock(TFCBlocks.peat))
					{
