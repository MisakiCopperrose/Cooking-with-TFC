...
public class TFCItems
{
	...
	public static Item primitiveBandage;
	public static Item bandage;
	public static Item sterileBandage;
	
	public static Item saddleTFC;
	
	//Cotton
	public static Item cottonSocks;
	public static Item cottonPants;
	public static Item cottonShirt;
	public static Item cottonCoat;
	public static Item cottonRobe;
	...
	public static Item stackedLogs;
	public static Item barrel;
	public static Item loom;
	public static Item primitiveLoom;
	...
	public static Item unstrungCompositeBow;
	public static Item unstrungCompositeBow2;
	public static Item hornStrips;
	...
	public static Item barleyGerm;
	public static Item ryeGerm;
	public static Item riceGerm;
	public static Item cornGerm;
	...
	public static Item grassCordage;
	public static Item linenString;
	public static Item silkString;
	public static Item cottonYarn;
	public static Item cotton;
	public static Item cottonCloth;
	...
	public static Item wolfFurScrap;
	public static Item bearFurScrap;
	public static Item fur;
	public static Item furScrap;
	...
	public static Item flatHide;
	public static Item flatBurlap;
	public static Item flatCotton;
	...
	public static Item wheatBeer;
	public static Item cornBeer;
	public static Item ryeBeer;
	public static Item riceBeer;
	public static Item wheatWine;
	public static Item ryeWine;
	public static Item cornWine;
	public static Item grapeJuice;
	public static Item barleyWine;
	public static Item caneWine;
	public static Item potatoWine;
	public static Item agaveWine;
	public static Item brandy;
	public static Item berryBrandy;
	public static Item appleJack;
	public static Item shochu;
	public static Item barleyWhiskey;
	public static Item riceWhiskey;
	...
	public static Item fruitWine;
	public static Item wine;
	public static Item fruitBrandy;
	public static Item whiskey;
	public static Item cornWhiskey;
	public static Item mead;
	public static Item honeybowl;
	public static Item honeyBrandy;
	public static Item clayBucketHoney;
	public static Item woodenBucketHoney;
	...
	public static Item hideBag;
	public static Item leatherBag;
	public static Item bagPiece;
	...
	public static Item emptyHoneycomb;
	public static Item honeycomb;
	public static Item fertileHoneycomb;
	...
	public static Item stoneFlake;
	public static Item fletchedArrow;
	public static Item rope;
	public static Item repairPatch;
	...
	public static int cottonUses = 128;
	...
	//Tier 2
	public static float bronzeEff = 13.0F;
	public static float bismuthBronzeEff = 12.0F;
	public static float blackBronzeEff = 11.0F;
	//Tier 3
	public static float wroughtIronEff = 16.0F;
	//Tier 4
	public static float steelEff = 22.0F;
	//Tier 5
	public static float blackSteelEff = 25.0F;
	//Tier 6
	public static float blueSteelEff = 28.0F;
	public static float redSteelEff = 28.0F;
	...
	public static void registerItems()
	{
		...
		GameRegistry.registerItem(stackedLogs, stackedLogs.getUnlocalizedName());
		...
		GameRegistry.registerItem(clayBucketVinegar, clayBucketVinegar.getUnlocalizedName());
		...
		//Clothing
		GameRegistry.registerItem(sackPiece, sackPiece.getUnlocalizedName());
		...
		GameRegistry.registerItem(cast, cast.getUnlocalizedName());
		GameRegistry.registerItem(resin, resin.getUnlocalizedName());
		GameRegistry.registerItem(primitiveBandage, primitiveBandage.getUnlocalizedName());
		GameRegistry.registerItem(bandage, bandage.getUnlocalizedName());
		GameRegistry.registerItem(sterileBandage, sterileBandage.getUnlocalizedName());
		
		GameRegistry.registerItem(saddleTFC, saddleTFC.getUnlocalizedName());
		
		//Cotton
		GameRegistry.registerItem(cottonSocks, cottonSocks.getUnlocalizedName());
		GameRegistry.registerItem(cottonPants, cottonPants.getUnlocalizedName());
		GameRegistry.registerItem(cottonShirt, cottonShirt.getUnlocalizedName());
		GameRegistry.registerItem(cottonCoat, cottonCoat.getUnlocalizedName());
		GameRegistry.registerItem(cottonRobe, cottonRobe.getUnlocalizedName());
		GameRegistry.registerItem(cottonHat, cottonHat.getUnlocalizedName());
		...
		GameRegistry.registerItem(wolfFurGenericHat, wolfFurGenericHat.getUnlocalizedName());
		
		GameRegistry.registerItem(furBoots, furBoots.getUnlocalizedName());
		GameRegistry.registerItem(furCoat, furCoat.getUnlocalizedName());
		GameRegistry.registerItem(furHat, furHat.getUnlocalizedName());
		...
		GameRegistry.registerItem(bearFurGenericHat, bearFurGenericHat.getUnlocalizedName());
		
		//Straw
		GameRegistry.registerItem(strawSocks, strawSocks.getUnlocalizedName());
		...
		GameRegistry.registerItem(emptyHoneycomb, emptyHoneycomb.getUnlocalizedName());
		GameRegistry.registerItem(honeycomb, honeycomb.getUnlocalizedName());
		GameRegistry.registerItem(fertileHoneycomb, fertileHoneycomb.getUnlocalizedName());
		...
		GameRegistry.registerItem(doorWattle, doorWattle.getUnlocalizedName());
		...
		GameRegistry.registerItem(grapeJuice, grapeJuice.getUnlocalizedName());
		GameRegistry.registerItem(beer, beer.getUnlocalizedName());
		GameRegistry.registerItem(riceBeer, riceBeer.getUnlocalizedName());
		GameRegistry.registerItem(wheatBeer, wheatBeer.getUnlocalizedName());
		GameRegistry.registerItem(cornBeer, cornBeer.getUnlocalizedName());
		GameRegistry.registerItem(ryeBeer, ryeBeer.getUnlocalizedName());
		GameRegistry.registerItem(barleyWine, barleyWine.getUnlocalizedName());
		GameRegistry.registerItem(caneWine, caneWine.getUnlocalizedName());
		GameRegistry.registerItem(agaveWine, agaveWine.getUnlocalizedName());
		GameRegistry.registerItem(potatoWine, potatoWine.getUnlocalizedName());
		GameRegistry.registerItem(wheatWine, wheatWine.getUnlocalizedName());
		GameRegistry.registerItem(cornWine, cornWine.getUnlocalizedName());
		GameRegistry.registerItem(ryeWine, ryeWine.getUnlocalizedName());
		GameRegistry.registerItem(cider, cider.getUnlocalizedName());
		GameRegistry.registerItem(appleJack, appleJack.getUnlocalizedName());
		GameRegistry.registerItem(rum, rum.getUnlocalizedName());
		GameRegistry.registerItem(ryeWhiskey, ryeWhiskey.getUnlocalizedName());
		GameRegistry.registerItem(riceWhiskey, riceWhiskey.getUnlocalizedName());
		GameRegistry.registerItem(barleyWhiskey, barleyWhiskey.getUnlocalizedName());
		GameRegistry.registerItem(sake, sake.getUnlocalizedName());
		GameRegistry.registerItem(shochu, shochu.getUnlocalizedName());
		GameRegistry.registerItem(vodka, vodka.getUnlocalizedName());
		GameRegistry.registerItem(tequila, tequila.getUnlocalizedName());
		GameRegistry.registerItem(berryWine, berryWine.getUnlocalizedName());
		GameRegistry.registerItem(fruitWine, fruitWine.getUnlocalizedName());
		GameRegistry.registerItem(wine, wine.getUnlocalizedName());
		GameRegistry.registerItem(mead, mead.getUnlocalizedName());
		GameRegistry.registerItem(honeyBrandy, honeyBrandy.getUnlocalizedName());
		GameRegistry.registerItem(brandy, brandy.getUnlocalizedName());
		GameRegistry.registerItem(berryBrandy, berryBrandy.getUnlocalizedName());
		GameRegistry.registerItem(fruitBrandy, fruitBrandy.getUnlocalizedName());
		...
		GameRegistry.registerItem(honeybowl, honeybowl.getUnlocalizedName());
		GameRegistry.registerItem(clayBucketHoney, clayBucketHoney.getUnlocalizedName());
		GameRegistry.registerItem(woodenBucketHoney, woodenBucketHoney.getUnlocalizedName());
		...
		GameRegistry.registerItem(grassCordage, grassCordage.getUnlocalizedName());
		GameRegistry.registerItem(linenString, linenString.getUnlocalizedName());
		GameRegistry.registerItem(cottonYarn, cottonYarn.getUnlocalizedName());
		GameRegistry.registerItem(cotton, cotton.getUnlocalizedName());
		GameRegistry.registerItem(cottonCloth, cottonCloth.getUnlocalizedName());
		...
		GameRegistry.registerItem(wolfFurScrap, wolfFurScrap.getUnlocalizedName());
		GameRegistry.registerItem(bearFurScrap, bearFurScrap.getUnlocalizedName());
		GameRegistry.registerItem(fur, fur.getUnlocalizedName());
		GameRegistry.registerItem(furScrap, furScrap.getUnlocalizedName());
		...
		GameRegistry.registerItem(flatBurlap , flatBurlap.getUnlocalizedName());
		GameRegistry.registerItem(flatHide , flatHide.getUnlocalizedName());
		GameRegistry.registerItem(flatCotton , flatCotton.getUnlocalizedName());
		...
		GameRegistry.registerItem(flatFur, flatFur.getUnlocalizedName());
		...
		GameRegistry.registerItem(hideBag, hideBag.getUnlocalizedName());
		GameRegistry.registerItem(leatherBag, leatherBag.getUnlocalizedName());
		GameRegistry.registerItem(bagPiece, bagPiece.getUnlocalizedName());
		GameRegistry.registerItem(repairPatch, repairPatch.getUnlocalizedName());
		...
		GameRegistry.registerItem(brick , brick.getUnlocalizedName());
		...
		GameRegistry.registerItem(agave , agave.getUnlocalizedName());
		GameRegistry.registerItem(sisalFiber , sisalFiber.getUnlocalizedName());
		...
		GameRegistry.registerItem(compositeBow, compositeBow.getUnlocalizedName());
		GameRegistry.registerItem(unstrungCompositeBow, unstrungCompositeBow.getUnlocalizedName());
		GameRegistry.registerItem(unstrungCompositeBow2, unstrungCompositeBow2.getUnlocalizedName());
		GameRegistry.registerItem(hornStrips, hornStrips.getUnlocalizedName());
		...
		GameRegistry.registerItem(fletchedArrow, fletchedArrow.getUnlocalizedName());
		GameRegistry.registerItem(stoneFlake, stoneFlake.getUnlocalizedName());
		...
		GameRegistry.registerItem(wheatGerm, wheatGerm.getUnlocalizedName());
		GameRegistry.registerItem(barleyGerm, barleyGerm.getUnlocalizedName());
		GameRegistry.registerItem(ryeGerm, ryeGerm.getUnlocalizedName());
		GameRegistry.registerItem(riceGerm, riceGerm.getUnlocalizedName());
		GameRegistry.registerItem(cornGerm, cornGerm.getUnlocalizedName());
		...
		GameRegistry.registerItem(seedsAgave, seedsAgave.getUnlocalizedName());
		GameRegistry.registerItem(seedsCotton, seedsCotton.getUnlocalizedName());
