...
public class Armor 
{
	...
	public static Armor leather = 				new Armor(0, 150, 200, 200, "Leather");//Tier 0
	public static Armor leatherQuiver = 		new Armor(10, 0, 0, 0, "Leather Quiver");//Tier 0
	public static Armor woolCloth = 			new Armor(11, 50, 50, 25, "Wool Cloth");//Tier 0
	public static Armor linenCloth = 			new Armor(12, 40, 40, 15, "Linen Cloth");//Tier 0
	public static Armor cottonCloth = 			new Armor(13, 40, 40, 15, "Cotton Cloth");//Tier 0
	public static Armor silkCloth = 			new Armor(14, 100, 100, 75, "Silk Cloth");//Tier 0
	public static Armor bearFur = 				new Armor(15, 250, 300, 300, "Bear Fur");//Tier 0
	public static Armor wolfFur = 				new Armor(16, 200, 250, 250, "Wolf Fur");//Tier 0
	public static Armor strawClothes = 			new Armor(17, 25, 25, 25, "Straw");//Tier 0
	public static Armor fur = 					new Armor(18, 180, 220, 220, "Generic Fur");//Tier 0
