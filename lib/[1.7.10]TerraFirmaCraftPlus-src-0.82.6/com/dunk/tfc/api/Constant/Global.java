...
public class Global
{
	...
	public static final int oreSize = 300;
	public static final int oreGrade1Offset = 100;
	public static final int oreGrade2Offset = 200;
	...
	public static final int mineralSize = 100;
