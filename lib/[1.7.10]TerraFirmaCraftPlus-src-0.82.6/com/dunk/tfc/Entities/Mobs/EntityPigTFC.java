...
public class EntityPigTFC extends EntityPig implements IAnimal, ICausesDamage
{
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(TFC_MobData.PIG_HEALTH);// MaxHealth
	}
	...
	{
		float f = TFC_MobData.PIG_DAMAGE;
		int i = 1;
	...
	public EnumDamageType getDamageType(EntityLivingBase is)
	{
		...
		else if(is != null && is.worldObj != null &&  is instanceof IAnimal && is.worldObj.rand.nextBoolean() && ((IAnimal)is).getGender() == GenderEnum.MALE)
		{
