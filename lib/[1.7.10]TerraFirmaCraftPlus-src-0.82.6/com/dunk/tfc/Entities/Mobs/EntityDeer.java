...
public class EntityDeer extends EntityAnimal implements IAnimal
{
	...
	private static final int FAMILIARITY_CAP = 70; // Adult caps at 70 since
													// babies are currently
													// impossible
	...
	public String getCommandSenderName()
	{
		if (isDomesticated)
		{
			return TFC_Core.translate("entity.deerTFC.name");
		}
		return TFC_Core.translate("entity.deerTFC.name");
	}
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(TFC_MobData.DEER_HEALTH);// MaxHealth
	}
	...
	/*
	 * @Override protected void updateAITasks() { super.updateAITasks(); }
	 */
	...
	public boolean canMateWith(IAnimal animal)
	{
		return animal.getGender() != this.getGender() && this.isAdult() && animal
				.isAdult() && animal instanceof EntityDeer && ((IAnimal) animal)
	...
	public boolean checkFamiliarity(InteractionEnum interaction, EntityPlayer player)
	{
		...
		case BREED:
			...
			break;
		case NAME:
			flag = familiarity > 60 || isDomesticated;
			break;
		case TOLERATEPLAYER:
	...
	protected void dropFewItems(boolean par1, int par2)
	{
		...
		this.entityDropItem(new ItemStack(TFCItems.fur, 1, Math.max(0, Math.min(2, (int) (ageMod * sizeMod * 1.84)))),
				0);
	...
	public void familiarize(EntityPlayer ep)
	{
		...
		if (stack != null && stack.getItem() != null && stack.getItem().equals(TFCItems.powder) && stack
				.getItemDamage() == 9 && !familiarizedToday && canFamiliarize())
		{
	...
	public void onLivingUpdate()
	{
		...
		if (attackedVec != null)
		{
			// TerraFirmaCraft.log.info(this.entityId+", Vec:
			// "+attackedVec.xCoord+", "+attackedVec.yCoord+",
			// "+attackedVec.zCoord);
