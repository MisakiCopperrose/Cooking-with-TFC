...
public class EntitySkeletonTFC extends EntityMob implements IRangedAttackMob, ICausesDamage, IInnateArmor
{
	...
	public static Item getArmorItemForSlot(int par0, int par1)
	{
		...
		case 4:
			if (par1 == 0)
				...
				return TFCItems.bearFurGenericHat;//TFCItems.steelHelmet;
			break;
		case 3:
			if (par1 == 0)
				...
				return TFCItems.bearFurCoat;//TFCItems.steelChestplate;
			break;
		case 2:
			if (par1 == 0)
				...
				return null;//TFCItems.steelGreaves;
			break;
		case 1:
			if (par1 == 0)
				...
				return TFCItems.bearFurBoots;//TFCItems.steelBoots;
			break;
		default:
			return null;
		}
    ...
    protected boolean isValidLightLevel()
    {
        ...
        int l = this.worldObj.getSavedLightValue(EnumSkyBlock.Sky, i, j, k);
        if(celestialDaylight == 0)
        {
        	return false;
        }
        if (celestialDaylight > this.rand.nextInt(32))
        {
            return false;
        }
        else
        {
            ...
            if (this.worldObj.isThundering())
            {
                ...
                celestialDaylight -= 10;
                this.worldObj.skylightSubtracted = i1;
            }

            return celestialDaylight <= this.rand.nextInt(8);
        }
    }
