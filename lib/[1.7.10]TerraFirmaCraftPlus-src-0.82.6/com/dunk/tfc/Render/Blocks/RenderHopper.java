...
public class RenderHopper implements ISimpleBlockRenderingHandler
{
	...
	{
		IIcon stoneHopperIcon = ((BlockHopper)block).getIconFromItemMeta(metadata);
		renderer.setOverrideBlockTexture(stoneHopperIcon);
		renderer.setRenderBounds(0F, 0.7F, 0F, 0.1F, 1F, 1F);
		renderInvBlock(block, renderer);
		renderer.setRenderBounds(0.9F, 0.7F, 0F, 1F, 1F, 1F);
		renderInvBlock(block, renderer);
		renderer.setRenderBounds(0F, 0.7F, 0F, 1F, 1F, 0.1F);
		renderInvBlock(block, renderer);
		renderer.setRenderBounds(0F, 0.7F, 0.9F, 1F, 1F, 1F);
		renderInvBlock(block, renderer);
		
		renderer.setRenderBounds(0F, 0.6F, 0F, 1F, 0.7F, 1F);
		renderInvBlock(block, renderer);
		renderer.setRenderBounds(0.2F, 0.3F, 0.2F, 0.8F, 0.6F, 0.8F);
		renderInvBlock(block, renderer);
		renderer.setRenderBounds(0.4F, 0F, 0.4F, 0.6F, 0.3F, 0.6F);
		renderInvBlock(block, renderer);
	...
	public boolean renderBlockHopperMetadata(Block block, int x, int y, int z, int meta, boolean unknownBool, RenderBlocks renderer)
	{
		...
		IIcon iicon = block == TFCBlocks.stoneHopper? TFCBlocks.stoneHopper.getIcon(renderer.blockAccess, x, y, z, 0):BlockHopper.getHopperIcon("hopper_outside");
		IIcon iicon1 =  block ==TFCBlocks.stoneHopper? TFCBlocks.stoneHopper.getIcon(renderer.blockAccess, x, y, z, 0): BlockHopper.getHopperIcon("hopper_inside");
		f1 = 0.125F;
