...
public class ModelHorseTFC extends ModelBase
{
    ...
    public ModelHorseTFC()
    {
        ...
        this.mouthBottom.addBox(-2.0F, -0.0F, -6.5F, 4, 2, 5,-0.1f);
        this.mouthBottom.addBox(-2.0F, 0.75F, -6.5F, 4, 2, 5,-0.2f);
        ...
        this.muleLeftEar.addBox(0.45F, -16.0F, 4.0F, 2, 7, 1);
        ...
        this.muleRightEar.addBox(-2.45F, -16.0F, 4.0F, 2, 7, 1);
	...
	public void render(Entity entity, float minX, float minY, float minZ, float maxX, float maxY, float maxZ)
    {
        ...
        this.head.setRotationPoint(0, -2, -2);
        this.horseFaceRopes.rotateAngleX = this.horseFaceRopes.rotateAngleY = this.horseFaceRopes.rotateAngleZ = 0;
        this.head.rotateAngleX =-0.25f;
        this.horseFaceRopes.setRotationPoint(0, 0, 0); 
        this.mane.rotationPointY+=3f;
        this.horseLeftEar.rotateAngleX = this.muleLeftEar.rotateAngleX = -0.2f;
        this.horseRightEar.rotateAngleX = this.muleRightEar.rotateAngleX = -0.2f;
        this.horseLeftEar.rotateAngleY =  this.muleLeftEar.rotateAngleY =-0.4f;
        this.horseRightEar.rotateAngleY =this.muleRightEar.rotateAngleY = 0.4f;
        this.horseLeftEar.rotateAngleZ =this.muleLeftEar.rotateAngleZ = 0.25f;
        this.horseRightEar.rotateAngleZ = this.muleRightEar.rotateAngleZ =-0.25f;
        this.horseLeftEar.setRotationPoint(1f, -1, -1);
        this.muleLeftEar.setRotationPoint(1f, -1, -1);
        this.horseRightEar.setRotationPoint(-1f, -1, -1);
        this.muleRightEar.setRotationPoint(-1f, -1, -1);
        this.mane.rotateAngleX += 0.6f;
        this.mouthTop.setRotationPoint(0.0F,  0F,-0f);
        this.mouthTop.rotateAngleX-=0;//.25f;
        this.mouthBottom.setRotationPoint(0.0F, -6.5F,0.5f);
        this.mouthBottom.rotateAngleX-=0.25f;
        ...
        if (flag3)
        {
            this.muleLeftEar.isHidden = false;//render(maxZ);
            this.muleRightEar.isHidden = false;//render(maxZ);
            this.horseLeftEar.isHidden = true;//render(maxZ);
            this.horseRightEar.isHidden = true;//render(maxZ);
        }
        else
        {
        	this.muleLeftEar.isHidden = true;//render(maxZ);
            this.muleRightEar.isHidden = true;//render(maxZ);
            this.horseLeftEar.isHidden = false;//render(maxZ);
            this.horseRightEar.isHidden = false;//render(maxZ);
            //this.horseLeftEar.render(maxZ);
            //this.horseRightEar.render(maxZ);
        }

        this.muleLeftEar.isHidden = false;//render(maxZ);
        this.muleRightEar.isHidden = false;
	...
	public void setLivingAnimations(EntityLivingBase entity, float x, float y, float z)
    {
        ...
        float f9 = entityhorse.getRearingAmount(2f);
        float f10 = 1.0F - f9;
        ...
        this.muleLeftEar.rotationPointY = this.horseLeftEar.rotationPointY;
        this.muleRightEar.rotationPointY = this.horseRightEar.rotationPointY;
        ...
        this.muleLeftEar.rotationPointZ = this.horseLeftEar.rotationPointZ;
        this.muleRightEar.rotationPointZ = this.horseRightEar.rotationPointZ;
        ...
        this.muleLeftEar.rotateAngleX = this.horseLeftEar.rotateAngleX;
        this.muleRightEar.rotateAngleX = this.horseRightEar.rotateAngleX;
