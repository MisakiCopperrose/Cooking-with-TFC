...
public class ModelLoom extends ModelBase {
	...
	public void render(int numStrings, int numMaxStrings, int tick, boolean shouldClothIncrease, int tickMod, ResourceLocation stringTex, boolean isWeaving, boolean stillWeaving, TELoom te) {
		...
		boolean primitive = te.primitive;
		...
		for(int i = 0; i < numStrings; i+=2){
			...
			initialString[i] = new TexturedQuad(new PositionTextureVertex[] {vert0, vert1, vert3, vert2}, 
			...
			finalString[i] = new TexturedQuad(new PositionTextureVertex[] {vert0, vert1, vert3, vert2}, 
			...
			vert3 = new PositionTextureVertex(
					...
					8,8);
			if(i+1 < numStrings){
				initialString[i+1] = new TexturedQuad(new PositionTextureVertex[] {vert0, vert1, vert3, vert2}, 
				...
				finalString[i+1] = new TexturedQuad(new PositionTextureVertex[] {vert0, vert1, vert3, vert2}, 
