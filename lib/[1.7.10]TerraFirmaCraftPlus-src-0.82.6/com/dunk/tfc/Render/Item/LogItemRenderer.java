...
public class LogItemRenderer implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		if(meta>=16)
		{
			...
			if(item != null && item.getItem() == TFCItems.stackedLogs)
			{	
				b = meta >= 24?TFCBlocks.stackedWoodHoriz4: TFCBlocks.stackedWoodHoriz3;
			}
			meta-=16;
		}
		else
		{
			...
			if(item != null && item.getItem() == TFCItems.stackedLogs)
			{		
				b = meta >= 8?TFCBlocks.stackedWoodHoriz2: TFCBlocks.stackedWoodHoriz;
			}
		}
