...
public class RenderHorseTFC extends RenderHorse
{
	...
	private static final ResourceLocation WILD_TEXTURE = new ResourceLocation(Reference.MOD_ID,
			"textures/mob/horse_wild.png");
	...
	private ResourceLocation getTexture(EntityHorse horse)
	{
		String s = horse.getHorseTexture();
		ResourceLocation resourcelocation = (ResourceLocation) TEXTURE_MAP.get(s);

		if (horse instanceof EntityHorseTFC && !((EntityHorseTFC) horse).isDomesticated())
		{
			return WILD_TEXTURE;
		}
		if (resourcelocation == null)
		{
			...
			else if (horse instanceof EntityHorseTFC)
			{
